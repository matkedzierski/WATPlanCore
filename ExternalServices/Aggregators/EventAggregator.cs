...
public static class EventAggregator
{
    ...
    public static async Task<IEnumerable<Event>?> GetPlanEvents(string planId)
    {
        ...
        return from ge in gEvents.Items.OrderBy(e => e.Start.DateTime) where ge.Start.DateTime != null && ge.End.DateTime != null
            ...
            select new Event(
                ...
                startTime: start, 
                endTime: end, 
                number: GetEventNumber(eventNumbers, name + type, start, end), 
                lecturer: details[0], 
                room: details[1], 
                groups: details[3], 
                info: details[2], 
